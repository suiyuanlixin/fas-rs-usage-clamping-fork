...
echo "0 500000" > /sys/module/cpufreq_clamping/parameters/margin
echo "1 500000" > /sys/module/cpufreq_clamping/parameters/margin
echo "2 500000" > /sys/module/cpufreq_clamping/parameters/margin
